...
benched  0x00110b8e: 216 settled, 85% won vs 69% needed, net +16.9% on $201,805, worst day -2,112, 22 of 43 exits under 10 min (capped: window read in full, older lookback cut, 5500 rows)
benched  0x09b045ba: 31 settled, 71% won vs 58% needed, net +10.2% on $12,220, worst day -333, 30 of 30 exits under 10 min
benched  0x1985327e: 51 settled, 71% won vs 54% needed, net +16.8% on $19,607, worst day -535, 49 of 49 exits under 10 min
benched  0x3f3aa700: 222 settled, 50% won vs 54% needed, net +4.1% on $677,671, worst day -24,321, 1 of 6 exits under 10 min (capped: window read in full, older lookback cut, 5500 rows)
benched  0x4980930d: 5 settled, 40% won vs 42% needed, net +54.5% on $6,146, worst day -1,358, 0 of 1 exits under 10 min
in form  0x5213eb85: 88 settled, 47% won vs 38% needed, net +7.6% on $43,855, worst day -2,314, 2 of 6 exits under 10 min
...
benched  0x9f15613e: 336 settled, 51% won vs 48% needed, net +6.2% on $1,058,059, worst day -32,014, 13 of 18 exits under 10 min (capped: window read in full, older lookback cut, 5500 rows)
in form  0xd25156e2: 70 settled, 66% won vs 48% needed, net +31.4% on $40,114, worst day -1,860, 3 of 27 exits under 10 min (capped: 10.0 of 14 days read, 5500 rows)
...
0xd970693a: 1 fail(s): does not lose at the prices we would really pay (-14% at real quotes over 31 matched copies)
