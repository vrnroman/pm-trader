# ops digest 2026-09-25T12:55:28.182453+00:00 (last 24h)

## money state
{"cash": 109.250143, "open_cost": 6.4, "equity": 115.65, "floor": 30.0, "stated": 80.0, "spend": {"date": "2026-09-25", "spent_usd": 12.8, "cap_usd": 54.0, "remaining_usd": 41.2, "closed_reason": ""}, "armed": true, "resolved_unclaimed": 68, "tier": {"1a": 0, "1b": 12.8, "1c": 0}, "ts": 1790340796.100946, "day": "2026-09-25"}

## arm: {"armed": true, "ts": 1789919410.9079125, "by": "telegram", "reason": "", "first_armed_ts": 1788617432.0499406, "floor_override": false}
## spend today: {"date": "2026-09-25", "spent_usd": 12.8, "wallet_copies": {"0x722abb5460060870d46728bf45f66a6b1635d6ed": 1}, "wallet_copies_yesterday": {"0x5213eb85fcd465c8927a8382f95dd2dc22306a35": 1, "0xd25156e222c9b907b128e27c36821fdb41db4d37": 1, "0x9f15613ebf1f36d4bc679e1211d1fc567cf9bdb3": 3, "0x722abb5460060870d46728bf45f66a6b1635d6ed": 1}, "yesterday": "2026-09-24", "closed_reason": ""}
...
two clocks: 140 matched fills over 1.0 d, api lag p50 29.5s, chain lag p50 8.8s, chain earlier by 21.7s at the median; api-only 106, chain-only 797, replayed rows 0; CHAIN IS PRIMARY
⏱ api lag cost, last 7d (estimate): +10.24 USD over 2793 fills at $6.40 each, +0.000 USD a fill at the median, chain earlier by 13.5s

## watcher (18 wakes in 24h)
...
b300 (floor $300): 7347 settled, 255 open, realized +1.8%, at their price +2.8% (net -8.0%), win rate 57%, feeds the Z gate
b150 (floor $150): 169 settled, 53 open, realized -9.4%, at their price -8.4% (net -19.4%), win rate 52%
b100 (floor $100): 209 settled, 61 open, realized -3.5%, at their price -2.5% (net -13.2%), win rate 51%
...
69fd3dc7d27e x19 last 0.6h ago [open: 19 hits, no action yet] :: INFO [daily-cap] +$N (copy:Nb) reserved | total today $N / $N
6c813168939b x22 last 0.6h ago [open: 22 hits, no action yet] :: ERROR [py_clob_client_v2] request error: Server disconnected
5f7bb5f89b09 x1 last 0.6h ago [open: 1 hits, no action yet] :: INFO [daily-cap] $N reservation kept: the post's fate is ambiguous (no order id)
54ac26fb3ff1 x60 last 0.7h ago [open: 60 hits, no action yet] :: ERROR [py_clob_client_v2] request error status=N url=https://clob.polymarket.com/price body={'S':'S'}
34253fa6334e x5 last 4.9h ago [open: 5 hits, no action yet] :: INFO [AB-RACE] rehearsal line sent, real-money line sent
c6d91d798e54 x16 last 5.7h ago [open: 16 hits, no action yet] :: INFO [tiered-risk] tier Nb: released $N of exposure from resolved or closed positions | open now: $N
2497cd50ff7d x3 last 9.3h ago [open: 3 hits, no action yet] :: INFO [ops] settled: 'S' -> 'S' | lost N on 'S' (<hex>, tier Nb)
eb7da12386c6 x18 last 10.5h ago [open: 18 hits, no action yet] :: TRADE [LIVE] BUY $N on 'S' @ N, order <hex>...
a77088f7944a x18 last 10.5h ago [open: 18 hits, no action yet] :: INFO [tiered-risk] Recorded tier Nb placement: $N | open: $N / $N
d7140f640d29 x17 last 10.5h ago [open: 17 hits, no action yet] :: TRADE [verify] FILLED: BUY N shares on 'S' @ N
6f12d4998994 x18 last 19.9h ago [open: 18 hits, no action yet] :: INFO [recovery] No pending orders to recover
6b829965c182 x18 last 19.9h ago [open: 18 hits, no action yet] :: INFO Bot started. Monitoring trades...
c47d62e70341 x18 last 19.9h ago [open: 18 hits, no action yet] :: INFO Received signal N, shutting down...
9d8a6d2794ec x11 last 19.9h ago [open: 11 hits, no action yet] :: ERROR [py_clob_client_v2] request error status=N url=https://clob.polymarket.com/auth/api-key body={'S':'S'}
c3db66a087f7 x3 last 20.7h ago [open: 3 hits, no action yet] :: WARNING [zset] ADMITTED <hex> to set Z (N over N copies with its best N deleted). Real money may now follow it once arme
790247505aab x3 last 20.7h ago [open: 3 hits, no action yet] :: INFO [ops] auto_admit: 'S' -> 'S' | N settled paper copies, paper ROI N, trimmed N, ideal N
9d498e122ffb x4 last 20.7h ago [open: 4 hits, no action yet] :: INFO [ops] form: 'S' -> 'S' | <hex>: N settled, N won vs N needed, net N on $N, worst day N, N of N exits under N min
b04bf1a60c1d x9 last 20.7h ago [open: 9 hits, no action yet] :: WARNING [zset] EVICTED <hex> from set Z: probation failed: N of N won, realized N on $N (pass needs N won and N)
89a855d4a192 x9 last 20.7h ago [open: 9 hits, no action yet] :: INFO [ops] evict: 'S' -> 'S' | probation failed: N of N won, realized N on $N (pass needs N won and N)
cf4709ce7c00 x1 last 20.7h ago [open: 1 hits, no action yet] :: INFO [ops] probation_failed: 'S' -> 'S' | lost N on 'S'LoL: Team WE vs JD Gami | Evict is reversible: /zset readmit
852039760707 x7 last 20.7h ago [open: 7 hits, no action yet] :: INFO [ops] probation_failed: 'S' -> 'S' | | Evict is reversible: /zset readmit
9713155b03b8 x1 last 20.7h ago [open: 1 hits, no action yet] :: INFO [ops] probation_failed: 'S' -> 'S' | lost N on 'S'Dota N: Pipsqueak+N vs | Evict is reversible: /zset readmit
ab787115fd71 x1 last 20.9h ago [open: 1 hits, no action yet] :: INFO [ops] form: 'S' -> 'S' | <hex>: N settled, N won vs N needed, net N on $N, worst day N, N of N exits under N min (c
680493f22dc3 x1 last 20.9h ago [open: 1 hits, no action yet] :: INFO [ops] form: 'S' -> 'S' | <hex>: N settled, N won vs N needed, net N on $N,N, worst day N, N of N exits under N min 
fe47bbb56041 x7 last 26.0h ago [open: 7 hits, no action yet] :: INFO [ops] form: 'S' -> 'S' | <hex>: N settled, N won vs N needed, net N on $N, worst day N
d96f6949e1c9 x3 last 32.0h ago [open: 3 hits, no action yet] :: INFO [ops] form: 'S' -> 'S' | <hex>: N settled, N won vs N needed, net N on $N,N, worst day N (capped: window read in fu
7984db4fdbb9 x1 last 36.1h ago [open: 1 hits, no action yet] :: INFO [ops] escalation_delivered: 'S' -> 'S' | Second order rejection today from the unclaimed winnings problem you were 
534614711c15 x2 last 37.6h ago [open: 2 hits, no action yet] :: ERROR [py_clob_client_v2] request error status=N url=https://clob.polymarket.com/order body={'S':'S'}
eb6ff024b864 x1 last 46.1h ago [open: 1 hits, no action yet] :: INFO [verify] UNFILLED, cancelled order <hex>...
c01c65915062 x1 last 48.4h ago [open: 1 hits, no action yet] :: INFO [ops] form: 'S' -> 'S' | <hex>: N settled, N won vs N needed, net N on $N, worst day N (capped: N of N days read, N
